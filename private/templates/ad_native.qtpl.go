...
//line templates/ad_native.qtpl:2
package templates
...
//line templates/ad_native.qtpl:9
import (
	qtio422016 "io"
...
//line templates/ad_native.qtpl:23
		qw422016.N().D(int(it.AdID()))
//line templates/ad_native.qtpl:23
		qw422016.N().S(`(0);v`)
//line templates/ad_native.qtpl:23
...
//line templates/ad_native.qtpl:24
		qw422016.N().S(asset.Path)
//line templates/ad_native.qtpl:24
		qw422016.N().S(`';</script><a target="_blank" href="`)
//line templates/ad_native.qtpl:26
		qw422016.N().S(urlStr)
//line templates/ad_native.qtpl:26
...
//line templates/ad_native.qtpl:26
		qw422016.N().S(`);"></a>`)
//line templates/ad_native.qtpl:27
	} else {
//line templates/ad_native.qtpl:27
		qw422016.N().S(`<a target="_blank" href="`)
//line templates/ad_native.qtpl:28
		qw422016.N().S(urlStr)
//line templates/ad_native.qtpl:28
...
//line templates/ad_native.qtpl:29
		qw422016.N().D(int(it.AdID()))
//line templates/ad_native.qtpl:29
		qw422016.N().S(`(0);v`)
//line templates/ad_native.qtpl:29
...
//line templates/ad_native.qtpl:31
		qw422016.N().S(asset.Path)
//line templates/ad_native.qtpl:31
		qw422016.N().S(`" type="`)
//line templates/ad_native.qtpl:31
...
//line templates/ad_native.qtpl:31
		qw422016.N().S(`" />`)
//line templates/ad_native.qtpl:32
		for _, thumb := range asset.Thumbs {
//line templates/ad_native.qtpl:33
			if thumb.IsVideo() {
//line templates/ad_native.qtpl:33
				qw422016.N().S(`<source src="`)
//line templates/ad_native.qtpl:34
...
//line templates/ad_native.qtpl:34
				qw422016.N().S(`" />`)
//line templates/ad_native.qtpl:35
			}
//line templates/ad_native.qtpl:36
		}
//line templates/ad_native.qtpl:36
		qw422016.N().S(`Your browser does not support HTML5 video.</video></a>`)
//line templates/ad_native.qtpl:39
	}
//line templates/ad_native.qtpl:39
	qw422016.N().S(`</div><div class="label">`)
//line templates/ad_native.qtpl:42
	for _, field := range config.Fields {
//line templates/ad_native.qtpl:43
		if val := it.ContentItem(field.Name); val != nil {
//line templates/ad_native.qtpl:44
			if vl, _ := field.Prepare(it.ContentItem(field.Name)); vl != nil {
//line templates/ad_native.qtpl:44
				qw422016.N().S(`<a target="_blank" href="`)
//line templates/ad_native.qtpl:45
				qw422016.N().S(urlStr)
//line templates/ad_native.qtpl:45
				qw422016.N().S(`" class="`)
//line templates/ad_native.qtpl:45
...
//line templates/ad_native.qtpl:45
				qw422016.N().S(`">`)
//line templates/ad_native.qtpl:46
				qw422016.N().S(gocast.ToString(vl))
//line templates/ad_native.qtpl:46
				qw422016.N().S(`</a>`)
//line templates/ad_native.qtpl:48
			}
//line templates/ad_native.qtpl:49
		}
//line templates/ad_native.qtpl:50
	}
//line templates/ad_native.qtpl:50
	qw422016.N().S(`</div></div>`)
//line templates/ad_native.qtpl:53
}
...
//line templates/ad_native.qtpl:56
...
//line templates/ad_native.qtpl:173
}
